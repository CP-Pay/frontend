      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <TouchableOpacity style={styles.interestContainer}>
            <Text style={styles.interestText}>Interest Credited Today: {formatCurrency(0)}</Text>
        ...
        <View style={styles.availableBalanceSection}>
          <TouchableOpacity style={styles.balanceRow}>
            ...
            <View style={styles.balanceRowRight}>
              <Text style={styles.balanceRowAmount}>{formatCurrency(user.walletBalance)}</Text>
          ...
          <TouchableOpacity style={styles.balanceRow}>
            ...
            <View style={styles.balanceRowRight}>
              <Text style={styles.balanceRowAmount}>{formatCurrency(user.owealthBalance)}</Text>
              <MaterialCommunityIcons name="chevron-right" size={20} color={Colors.textSecondary} />
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.featureCardsContainer}>
          ...
          <View style={styles.featureCard}>
            <View style={styles.featureCardHeader}>
              <MaterialCommunityIcons name="safe-square" size={32} color={Colors.primary} />
