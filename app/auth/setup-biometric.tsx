...
export default function SetupBiometricScreen() {
  ...
  const { pin, mnemonic } = useLocalSearchParams<{ pin: string; mnemonic: string }>();
      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.subtitle}>
            {biometricAvailable
              ? `Use your ${biometricType === 'face' ? 'face' : 'fingerprint'} to quickly unlock your wallet and authorize transactions`
            ...
            <>
              ...
              >
                <Text style={styles.enableButtonText}>
                  {loading ? 'Setting up...' : `Enable ${biometricType === 'face' ? 'Face ID' : 'Fingerprint'}`}
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
