...
export default function WaterScreen() {
  ...
  const handleProceed = () => {
    ...
    Alert.alert('Coming Soon', 'Water bill payment will be processed via TransactionService');
  };
        ...
        <ScrollView style={styles.content}>
          <View style={styles.section}>
            ...
            <TouchableOpacity style={styles.input}>
              <Text style={provider ? styles.text : styles.placeholder}>{provider || 'Select water board'}</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.section}>
